...
public class QuintaRodadaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tabelaResultadoVazio = (ListView) view.findViewById(R.id.quinta_rodada_tabela_vazia);
        ...
        listaJogo = jogoService.listarDadosPorRodadaETurno(getActivity().getBaseContext(), 5, 1);
