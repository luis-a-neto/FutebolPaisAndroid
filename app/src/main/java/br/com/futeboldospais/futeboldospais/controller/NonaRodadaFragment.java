...
public class NonaRodadaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tabelaResultadoVazio = (ListView) view.findViewById(R.id.nona_rodada_tabela_vazia);
        ...
        listaJogo = jogoService.listarDadosPorRodadaETurno(getActivity().getBaseContext(), 9, 1);
