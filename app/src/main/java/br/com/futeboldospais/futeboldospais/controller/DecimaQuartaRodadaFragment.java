...
public class DecimaQuartaRodadaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tabelaResultadoVazio = (ListView) view.findViewById(R.id.decimaquarta_rodada_tabela_vazia);
        ...
        listaJogo = jogoService.listarDadosPorRodadaETurno(getActivity().getBaseContext(), 14, 2);
