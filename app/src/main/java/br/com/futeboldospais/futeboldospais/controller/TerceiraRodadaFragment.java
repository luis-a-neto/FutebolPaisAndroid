...
public class TerceiraRodadaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tabelaResultadoVazio = (ListView) view.findViewById(R.id.terceira_rodada_tabela_vazia);
        ...
        listaJogo = jogoService.listarDadosPorRodadaETurno(getActivity().getBaseContext(), 3, 1);
