...
public class DecimaPrimeiraRodadaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tabelaResultadoVazio = (ListView) view.findViewById(R.id.decimaprimeira_rodada_tabela_vazia);
        ...
        listaJogo = jogoService.listarDadosPorRodadaETurno(getActivity().getBaseContext(), 11, 2);
